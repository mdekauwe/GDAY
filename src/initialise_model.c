...
void initialise_control(control *c) {
    ...
    */
    ...
    c->input_ascii = TRUE;          /* If this is false the code expects and input binary file with the met data. */
    ...
    c->nrows = 0;                   /* Number of rows in binary file, only relevant if input_ascii = FALSE */
    c->ncols = 0;                   /* Number of cols in binary file, only relevant if input_ascii = FALSE */
    ...
    c->ovars = 19;                  /* Number of vars in output array file */
    c->yovars = 17;                  /* Number of vars in output binary file */
...
void initialise_params(params *p) {
    ...
    */
    ...
    p->soil_layers = 20;             /* number of soil layers */
    p->core = p->soil_layers + 1;    /* number of soil layers + 1 */
